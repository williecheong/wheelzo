...
@section('description')
    @if ($requested_ride) 
        ...
        <link rel="image_src"  href="/assets/img/screenshot-ride_200x200.png">
        <meta property="og:image" content="{{ base_url() }}assets/img/screenshot-ride_200x200.png"/>
    ...
    @elseif ($requested_user) 
        ...
        <link rel="image_src"  href="/assets/img/screenshot-review_200x200.png">
        <meta property="og:image" content="{{ base_url() }}assets/img/screenshot-review_200x200.png"/>
        <meta property="og:image:width" content="200" />
        <meta property="og:image:height" content="200" />
    ...
    @else
        ...
        <link rel="image_src"  href="/assets/img/screenshot-main_200x200.png">
        <meta property="og:image" content="{{ base_url() }}assets/img/screenshot-main_200x200.png"/>
        <meta property="og:image:width" content="200" />
        <meta property="og:image:height" content="200" />
